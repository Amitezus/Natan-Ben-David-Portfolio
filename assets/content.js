...
C.ui = {
  ...
  heroSub:    ['I solve problems in visual communication — branding and print, video and motion, product and interface. Different media, one question: what a person will notice, understand and remember.',
               'פותר בעיות בתקשורת חזותית — מיתוג ודפוס, וידאו ומוֹשן, מוצר וממשק. מדיומים שונים, שאלה אחת: מה אדם ישים לב אליו, יבין ויזכור.'],
